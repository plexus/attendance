(defproject attendance "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "attendance.core/on-figwheel-reload"}

                :compiler {:main attendance.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/attendance.js"
